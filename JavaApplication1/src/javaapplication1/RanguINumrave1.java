...
public class RanguINumrave1 {
     public static void main(String[] args) {
        ...
        for (int i = 0; i < numri; i++) {
            ...
            if (numrat > 10 && numrat < 40)
            {
                numerimi++;
            } 
        }
        System.out.println("Ju keni shtypur " + numri + " numrat dhe nga keta numra " + numerimi + " jane ne mes te numrave 10-40");
